...
urlpatterns = [
    ...
    path('create_review_and_ticket/', blog.views.create_review_and_ticket, name='create_review_and_ticket'),
    ...
    path('my_tickets/', blog.views.my_tickets, name='my_tickets'),
    path('my_reviews/', blog.views.my_reviews, name='my_reviews'),
